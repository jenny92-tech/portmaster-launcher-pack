...
# One local diagnostic log per launch. LOVE-lite and its embedded Rust service
# inherit these descriptors, so initialization failures and runtime errors land
# in the same file without a shell-side logging process.
