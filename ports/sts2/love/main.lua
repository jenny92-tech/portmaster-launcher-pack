...
launcher.define {
    ...
    fields = {
        ...
        launcher.toggle {key = "swap_ab", label = {en = "Swap A/B:", zh = "交换 A/B:"}, default = "on", env = "SLL_SWAP_AB"},
        launcher.toggle {key = "swap_xy", label = {en = "Swap X/Y:", zh = "交换 X/Y:"}, env = "SLL_SWAP_XY"},
    },
