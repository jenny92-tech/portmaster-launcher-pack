...
The production APP Manager runtime adapts the LOVE API and software pixel-buffer implementation
...
Balatro-specific Lua patches were intentionally not imported. Its production
scope is deliberately limited to Port App Manager; ordinary game launchers
continue to use PortMaster's LÖVE 11.5 runtime. Local changes
